...
public class WheelView extends View {
     ...
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0xFF888888; // 0xF0000000  0xFF444444
     ...
     */
    private static final int ADDITIONAL_ITEM_HEIGHT = 20; // 15  20
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize(dp2px(TEXT_SIZE));
        }
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setTextSize(dp2px(TEXT_SIZE));
