...
import com.water.helper.MemberSelectActivity;
 ...
 */
@Component(dependencies = AbsAppComponent.class, modules = {MemberSelectModule.class})
public interface MemberSelectPresenterComponent {

    // 可以注册多个页面
    void inject(MemberSelectActivity memberSelectActivity);
}
