...
import com.water.helper.CheckUserInfoActivity;
 ...
 */
@Component(dependencies = AbsAppComponent.class, modules = {CheckUserInfoModule.class})
public interface CheckUserInfoPresenterComponent {

    // 可以注册多个页面
    void inject(CheckUserInfoActivity checkUserInfoActivity);
}
