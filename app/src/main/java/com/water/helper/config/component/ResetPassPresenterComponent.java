...
import com.water.helper.ResetPassActivity;
 ...
 */
@Component(dependencies = AbsAppComponent.class, modules = {ResetPassModule.class})
public interface ResetPassPresenterComponent {
