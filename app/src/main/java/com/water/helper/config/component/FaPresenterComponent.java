...
import com.water.helper.FaActivity;
 ...
 */
@Component(dependencies = AbsAppComponent.class, modules = {FaModule.class})
public interface FaPresenterComponent {
     ...
     * 登录页面
     */
    void inject(FaActivity faActivity);
}
