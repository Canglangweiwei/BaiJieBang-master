...
import com.water.helper.ShouActivity;
 ...
 */
@Component(dependencies = AbsAppComponent.class, modules = {ShouModule.class})
public interface ShouPresenterComponent {
     ...
     * 登录页面
     */
    void inject(ShouActivity shouActivity);
}
